      ...
      <div class="hidden md:block">
        <ul class="flex space-x-8 text-sm font-sans">
          ...
          <li>
            <a
              href="#"
              class="cta bg-white hover:bg-gray-400 px-3 py-2 rounded text-blue-500 hover:text-white border-solid border-1 border-sky-500 hover:border-1 hover:border-gray-400 font-semibold"
              >Sign In</a
            >
          </li>
          <li>
      ...
      >
        ...
        <ul class="divide-y font-sans">
          ...
          <li>
            <a
              href="#"
              class="my-8 w-full text-center font-semibold cta inline-block bg-gray-100 hover:bg-blue-600 px-3 py-2 rounded text-blue-400"
              @click="isOpen = false"
              >Sign In</a
            >
          </li>
